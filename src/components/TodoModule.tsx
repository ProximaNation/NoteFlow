  ...
  return (
    <div className="flex-1 p-8 bg-background">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-6 text-foreground">To-Do List</h1>
          ...
          <div className="flex space-x-4 mb-6">
            <input
              ...
              className="flex-1 px-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent bg-background text-foreground"
            />
            <button
              onClick={addTodo}
              className="px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all duration-300 hover:scale-105 flex items-center space-x-2"
            >
              <Plus size={18} />
              <span>Add Task</span>
            </button>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  {editingTodo === todo.id ? (
                    <input
                      ...
                      className="w-full font-medium text-card-foreground border-none outline-none bg-transparent"
                      autoFocus
                    />
                  ) : (
                    <span 
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="p-1 text-muted-foreground hover:text-blue-500 transition-colors duration-300"
                  >
                    <Edit2 size={16} />
                  </button>
                  ...
                  <button
                    ...
                    className="p-1 text-muted-foreground hover:text-red-500 transition-colors duration-300"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
        ...
        {filteredTodos.length === 0 && (
          <div className="text-center py-12 text-muted-foreground">
            <CheckSquare size={64} className="mx-auto mb-4 text-muted-foreground/50" />
            <p className="text-lg">
