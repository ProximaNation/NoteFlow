  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card dark:bg-card border border-border dark:border-border rounded-lg p-4">
        <h3 className="font-semibold mb-3 text-card-foreground dark:text-card-foreground flex items-center space-x-2">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex justify-between">
            <span className="text-muted-foreground dark:text-muted-foreground">Level:</span>
            <span className="font-medium text-purple-600 dark:text-purple-400">{userLevel}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-muted-foreground dark:text-muted-foreground">Badges:</span>
          ...
          {missions.slice(0, 3).map((mission) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h4 className="font-medium text-sm text-card-foreground dark:text-card-foreground">{mission.title}</h4>
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground">{mission.description}</p>
                </div>
                <div className="text-right">
                  <div className="text-xs font-medium text-purple-600 dark:text-purple-400">+{mission.xp} XP</div>
                  <div className="text-xs text-muted-foreground dark:text-muted-foreground">{mission.type}</div>
                </div>
              </div>
          ...
          {badges.map((badge) => {
            ...
            return (
              ...
              >
                ...
                />
                <h4 className="text-xs font-medium text-card-foreground dark:text-card-foreground mb-1">{badge.name}</h4>
                <p className="text-xs text-muted-foreground dark:text-muted-foreground">{badge.description}</p>
              </div>
            );
          })}
        </div>
